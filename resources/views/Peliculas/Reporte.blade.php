...
<br>
                            ...
                            <div align="center">
                                  ...
                                  <div class="col-md-12" >
                                        ...
                                        <img src="{{asset($peliculaItem->poster)}}" style="width:50%; height:auto ;" >
                                  ...
                                  <div class="col-md-12">
                                    <dl class="dl-horizontal">
                                      <dt>Tìtulo</dt><dd>{{$peliculaItem->titulo}}</dd>
                                        <br>
                                        <dt>Director</dt><dd>{{$peliculaItem->director}}</dd>
                                        <br>
                                        <dt>País</dt><dd>{{$peliculaItem->pais}}</dd>
                                        <br>
                                        <dt>Año</dt><dd>{{$peliculaItem->anio}}</dd>
                                        <br>
                                        <dt>Duración</dt><dd>{{$peliculaItem->duracion." minutos"}} </dd>
                                        <br>
                                        <dt>Subtitulos</dt><dd>{{$peliculaItem->subtitulos}}</dd>
                                        <br>
                                        <dt>Tipo</dt><dd>{{$peliculaItem->tipo}}</dd>
                                        <br>
                                        <dt>Trailer</dt><dd>@if($peliculaItem->trailer!=""){{$peliculaItem->trailer}}@else No tiene @endif</dd>
                                        <br>
