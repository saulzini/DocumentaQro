    ...
    <div  align="center">
        <br>
                <dl class="dl-horizontal">
                    ...
                    <dt>Nombre</dt><dd>{{ $integranteItem->nombre }}</dd><br>
                    <dt>Teléfono</dt><dd>{{ $integranteItem->telefono }}</dd><br>
                    <dt>Puesto</dt><dd>{{ $integranteItem->puesto }}</dd><br>
                    <dt>E-mail</dt><dd>{{ $integranteItem->email }}</dd><br>
                    @endif
                </dl>
    </div>
