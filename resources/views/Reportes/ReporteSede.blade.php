              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a href="{{route('reportesSede')}}" class="active">
                                  <i class="fa fa-map-marker"></i>
                                  <span>Sedes</span>
                              </a></li>
                ...
                <div class="row mt">
                    ...
                    <div class="col-lg-12">
                        <div class="form-panel">
                            <h4><i class="fa fa-angle-right"></i>Sedes</h4>
                            @include('Partials.Mensajes.mensajes')
                            <br>
                            <div class="row">
                                <div class="col-xs-12">
                                    {!! Form::open(['route' => 'reportesConsultarSedes' ,'method'=>'GET','role'=>'form','id'=>'defaultForm']) !!}
                    ...
                    @if(isset($resultados))
                           ...
                           <div align="center">
                            <table  class="table table-striped table-advance table-hover table_sort"  >
                                <thead >
                                <tr>
                                    <th><i class="fa fa-thumb-tack"></i> Sede </th>
                                ...
                                @foreach ($resultados as $resultado)
                                        ...
                                        <tr>
                                            <td style="width: 40%">{{$resultado['Sede']}}</td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <div class="col-lg-2">
                                            <dl class="dl-horizontal">
                                                <dt>Sedes</dt><dd>{{$resultados[0]['Sedes']}}</dd><br>
