                ...
                <div class="row mt">
                    ...
                    <div class="col-lg-12">
                        <div class="form-panel">
                            <h4 style="color:#F10687"><i class="fa fa-angle-right"></i>Festivales</h4>
                            @include('Partials.Mensajes.mensajes')
                            <br>
                            <div class="row">
                                <div class="col-xs-12">
                                    {!! Form::open(['route' => 'reportesConsultarFestivales' ,'method'=>'GET','role'=>'form','id'=>'defaultForm']) !!}
                           ...
                           <div align="center">
                            <table  class="table table-striped table-advance table-hover table_sort"  >
                                ...
                                @foreach ($resultados as $resultado)
                                        ...
                                        <tr>
                                            <td style="width: 40%">{{$resultado['Festival']}}</td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <div class="col-lg-2">
                                            <dl class="dl-horizontal">
                                                <dt>Festivales</dt><dd>{{$resultados[0]['Festivales']}}</dd><br>
