...
(function ($) {
    ...
    defaultPreviewSettings = {
        image: {width: "100% /9", height: "370px", maxWidth: "100%", display:"inline-block"},
        html: {width: "auto", height: "300px"},
        text: {width: "auto", height: "300px"},
        video: {width: "auto", height: "300px"},
        audio: {width: "auto", height: "300px"},
        flash: {width: "auto", height: "300px"},
        object: {width: "auto", height: "300px"},
        other: {width: "auto", height: "300px"}
    };
